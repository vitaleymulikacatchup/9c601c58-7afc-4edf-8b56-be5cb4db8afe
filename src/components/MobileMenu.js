              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <nav className="space-y-4">
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Case Studies</a>
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Blog</a>
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Contacts</a>
                ...
                <div>
                  <nav className="space-y-4">
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Web Development</a>
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Mobile Development</a>
                    <a href="#" className="block text-gray-600 hover:text-gray-900">Support and Maintenance</a>
                  </nav>
                </div>
              </div>
